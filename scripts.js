...
function genere(idUt,titre,auteur,type,genre,theme,resume,ressenti,pqRessenti,rating,quali,facon,recomm,age) {
	...
	return  titre +', écrit par '+ auteur +', est '+ type +' '+ genre +' qui parle '+ theme + '. '+ resume +" L'histoire nous fait ressentir "+ ressenti + ' ' + pqRessenti +'. '+ rating + quali +'. Ce livre '+ facon +" est "+ recomm +".Il est par ailleurs plutôt déstiné aux lecteurs à partir de "+ age +" ans!"; 
};
